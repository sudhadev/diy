...
?>
                  ...
                  <div class="option_form_catagories">
                    ...
                    <div class="text_fieldBlock_right">
                      <label>
                      <input name="company"  maxlength="27" type="text" class="signup_txtfields signup_txtfields_company" id="company" size="30" onfocus="removeMyClass(this);"/>
                      <div id="signup_txtfields_text_block"></div>
                      </label>
                    </div>
