...
//$objEmail->dev=true;
    ...
    if(!$_REQUEST['id']||is_nan($_REQUEST['id'])|| $_REQUEST['id']>2)  $_REQUEST['id']=0;
    // get items from Queue
    $result=$objExpiringItems->getByAlertNo((int)$_REQUEST['id'],'E');
    $newAlertNo=(int)$_REQUEST['id']+1;
    // sending emails
     for($e=0;$e<count($result);$e++)
     {
         if($result[$e][14]) $objEmail->send('expiration', $result[$e][14],$result[$e][8],'H', $result[$e][13]);
