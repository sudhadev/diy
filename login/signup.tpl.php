                  ...
                  <div id="form_cell_right">
                    ...
                    <div align="left">
                     <?php if(isset($_GET['bloc'])): ?>
                        <input name="uid" type="text" id="uid" class="supplier_login_textfield" 
                             value="<?php echo $_GET['bloc'] ?>" />
                        
                     <?php else: ?>
                      <input name="uid" type="text" id="uid" class="supplier_login_textfield" 
                             onfocus="handleLoginFields('none',this.name);" onblur="handleLoginFields('block',this.name);" 
                             onkeypress="handleLoginFields('change',this.name);" value="Email" 
                             style="color:#BBB;"/>
                      <?php endif; ?>
                    </div>
                    </label>
