...
{ 
      ...
      /*$('#list_submit_button-BT').show(); 
       ...
       $('#list_submit_button-hover-BT-2').hide();*/
      //  $('.listing_add_list_tr_class').hide(); 
...
function commitExtraDetails(control)
{
    ...
    var descript2=document.getElementById('listED').value;
    var descript_array = descript2.split(",");
    var descript='';
    ...
    var spec2=document.getElementById('listSPEC').value;
    var spec_array = spec2.split(",");
    var spec='';
    for (var i=0;i<spec_array.length;i++){
        if(i==0){
            spec=descript_array[i];
        }else{
            spec=spec+"&#8218;"+spec_array[i];
        }
    }
