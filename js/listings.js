...
{ 
    ...
    var unitCost = Number(document.getElementById("unit_cost_" + elementId).value);
    var bulkDiscount = Number(document.getElementById("select_bulk_discount_"+elementId).value);
    var bulkPrice= Number(document.getElementById("bulk_price_"+elementId).value);
    ...
    if(listingActive=='Y'){
    	...
    	if(unitCost<bulkPrice){val=1;
    		$('#'+"select_bulk_discount_"+elementId).attr("style", 'border: 1px solid red;');
    		$('#'+"bulk_price_"+elementId).attr("style", 'border: 1px solid red;');
    		$('#'+"unit_cost_"+elementId).attr("style", 'border: 1px solid red;');
    	}else{
    		if(bulkPrice!=0 && bulkDiscount==0){val=2;
    			$('#'+"select_bulk_discount_"+elementId).attr("style", 'border: 1px solid red;');
    			$('#'+"bulk_price_"+elementId).attr("style", 'border: 1px solid red;');
    		}else{ val=3;
    		...
    		$('#'+"unit_cost_"+elementId).attr("style", 'border: 1px solid #CBCBCB;');
    	}

        //alert('bul disc='+bulkDiscount+'--bulk price='+bulkPrice+'--unit='+unitCost+' >>'+val);
    	/*
    	if(bulkPrice!=0 && bulkPrice!='0.00' && bulkPrice!='' && bulkPrice!=null){
    		if(bulkDiscount==0){
    			$('#'+"select_bulk_discount_"+elementId).attr("style", 'border: 1px solid red;');
...
{ 
       ...
       // var rowCount = document.getElementById("rowCount").value;
        ...
        for(var i=0; i<rowCount; i++)
        {
            ...
            var unitCost = document.getElementById("unit_cost_" + elementId).value.replace(',','');
            var bulkDiscount = document.getElementById("select_bulk_discount_"+elementId).value.replace(',','');
            var bulkPrice=document.getElementById("bulk_price_"+elementId).value.replace(',','');
            var delivery=document.getElementById("delivery_"+elementId).value.replace(',','');
            var listingActive=document.getElementById("listing_active_"+elementId).value;
            ...
            var rate=document.getElementById("actual_list_rate_"+elementId).value.replace(',','');
...
{ 
   // alert(values_of_rows);
    ...
    reqListing.send("val=add_edit" + "&rowValues="+ encodeURI(values_of_rows)+"&");
