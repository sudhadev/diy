...
(document, 'script', 'twitter-wjs');</script>
        ...
        <td style="vertical-align: top;float: left;">
            ...
            <iframe src="image-gallery.php?catid=3&lid=<?php echo $list[0][0]; ?>&cid=<?php echo $_REQUEST['cid']; ?>" width='330px' height='400px' frameborder='0' scrolling="no" id="fbtake"></iframe>
            </td>
            </tr>
