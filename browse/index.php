        ...
        { 
            ...
            {                 
                ...
                if($msg[0] == "SUC")
                {
                    ...
                    {/*edit by madurang - for wishlist*/
                        $redirect_URL='page=browse&';
                        $redirect_URL.="f=".$_REQUEST['f']."&";  
                        $redirect_URL.="tcid=".$_REQUEST['tcid']."&"; //
                        $redirect_URL.="categoryId=".$_REQUEST['categoryId']."&";//
                        $redirect_URL.="specificationId=".$_REQUEST['specificationId']."&";//
                        $redirect_URL.="manufacturerId=".$_REQUEST['manufacturerId']."&";//
                        $redirect_URL.="order_by=".$_REQUEST['order_by']."&";//
                        $redirect_URL.="pg=".$_REQUEST['pg']."&";//
                        $redirect_URL.="categories=".$_REQUEST['categories']."&";//
                        $redirect_URL.="pcid=".$_REQUEST['pcid'];//
                        
                        header("Location:".$objCore->_SYS['CONF']['URL_LOGIN_FRONT']."/?guest=Y&".$redirect_URL); 
                    }
                }
            } else
            {
