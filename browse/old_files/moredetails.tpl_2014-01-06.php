...
<form id="moredetails_supplies" name="moredetails_supplies" method="POST" action="<?php echo $objCore->_SYS['CONF']['URL_LOGIN_FRONT'];?>">
    ...
    <table style="float:left;">
        ...
        <?php echo $list[0][15].'<br/><br/>';
        
        //echo $speclist[0][9];?></span>
            </p>
                                                                 </div>
...
<!--SPECIFICATION-->
</span><?php echo '<br/>'. str_replace('-amp;','&',htmlspecialchars_decode($speclist[0][13])).'<br/><br/>';
               // echo $list[0][20];?></span>
            </p>
                                                                 </div>
        ...
        <td>
            ...
            <table cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        <td width="30">
            Mon - Fri</td> <td width="10"></td><td><?php echo $mon_det[0]==0?"Closed":$mon_det[0].":00 - ".$mon_det[1].':00';?></td></tr>
             <tr>  <td>
                    Saturday</td> <td width="10"></td>
                      <?php
                        if($sat_det[0]==0){
                             ...
                             echo "<td>".$sat_det[0].":00 - ".$sat_det[1].":00</td>";
                        }
                            ?>
             </tr>
             <tr>
                    ...
                    Sunday</td> <td width="10px"></td>
                        ...
                        if($sun_det[0]==0){
                            ...
                            echo "<td>".$sun_det[0].":00 - ".$sun_det[1].":00</td>";
                        }
                            ?>
                        </tr>
                </tbody>
