...
<!--        <div id="toggle_buttons" style="float:left; margin-left: 6px;height: 25px;">
        ...
        <td style="float: right;">
            ...
            <iframe src="image-gallery.php?catid=2&lid=<?php echo $list[0][17]; ?>" width='330px' height='400px' frameborder='0' style="margin-top: -7px;" scrolling="no"></iframe>
            </td>
            </tr>
...
<table class="common_text">
    ...
    <tr><td style="padding-left: 6px"><b>Website </b></td>
        ...
        <td><a href="<?php echo 'http://'.str_replace('http://','',$list[0][18]);?>"><?php echo $list[0][18];?></a> </td></tr>
    
    <tr><td style="padding-left: 6px"><b>Distance </b></td>
        <td width="10px;">:
                        </td>
                        <td><?php echo $_REQUEST['dis']; ?>&nbsp; <?php echo $_REQUEST['unit']; ?></td></tr>
