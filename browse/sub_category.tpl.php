            ...
            case '2':
                {
                  ...
                  echo  $listCount=$objService->getListingCountsByCategories($_REQUEST['tcid'],$pcid);
                  	*/
                	
                	/* this change for browse list count issue -2014-03-21 -Maduranga */
                  require_once($objCore->_SYS['PATH']['CLASS_LISTING']);
                  if(!is_object($objListing)) $objListing=new Listing();
                  
                  $listCount=$objListing->getListingsforACategory($_REQUEST['tcid'],$pcid);
            ...
            <div id="middle_center_bar_content">
              ...
              ?>
               ...
               <div class="breadcrumb"><a href="?tcid=<?php echo $_REQUEST['tcid'];?>"> <?php echo $topLevelCat['category']; ?> </a> > <?php echo $breadCrumleve2[1]; ?> </div>
                   ...
                   <?php echo '<p>'.$secondLevelCat['description'].'</p>'; ?>
                  ...
                  <?php    } break;
                      ...
                      <?php     } ?>
                       ...
                       <div class="nav-menu">
                       <ul>
                            <li><a href="?f=result&tcid=<?php echo $_REQUEST['tcid'];?>&pcid=<?php echo $secondLevelCat['id'];?>&categories=<?php echo $_REQUEST['tcid'];?>&categoryId=<?php echo $secondLevelCat['id'];?>&pg=1">Miscellaneous</a>&nbsp;[<?php echo $listCount;?>]</li>
                        </ul>
                       </div>
                       ...
                       ?>
		                ...
		                <div class="nav-menu">
                          ...
                          <?php
                                 ...
                                 default:
                                 { // change by maduranga for product list count issue 
                                 	$p_count=$objListing->getListingsforACategory_supply_2($_REQUEST['tcid'],$_REQUEST['pcid'],$listSub[$d][0] );
                          ?>
                                    <li><a href="?f=spec&tcid=<?php echo $_REQUEST['tcid'];?>&pcid=<?php echo  $_REQUEST['pcid'];?>&catId=<?php echo $listSub[$d][0];?>" ><?php echo $listSub[$d][3];?></a>&nbsp;[<?php echo $p_count;?>]</li>
                          <?php
                                 }break;
                                }
		                    }
