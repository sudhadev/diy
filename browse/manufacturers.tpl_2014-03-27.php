            ...
            <div class="middle_center_bar_cells_head">
                ...
                <div class="nav-menu">
                    <ul>
                        ...
                        <li><a href="?f=result&tcid=<?php echo $_REQUEST['tcid'];?>&categories=1&categoryId=<?php echo $_REQUEST['catId'];?>&specificationId=<?php echo $manufacDataArray[$manufacKeyArray[$a]][$b][0];?>&manufacturerId=<?php echo $manufacDataArray[$manufacKeyArray[$a]][$b][1];?>&order_by=<?php echo $_REQUEST['order_by']?>&pg=1"><?php echo $manufacArray[$manufacKeyArray[$a]][$b];?>
                        </a></li>
                        <?php }?>
                    </ul>
                </div>
