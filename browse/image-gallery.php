         ...
         elseif($catid=='2'){
          ...
          elseif($catid=='3'){
             ...
             //   print_r($image_arrays);
              ...
              //  echo '<br>';
              //  echo $objCore->_SYS['CONF'][$ftploc].'/thumbs/'.$list_spec[0][0];
                //http://demo.diypricecheck.co.uk/data/images/specifications//thumbs/_1390899174_qsa99m4tc.jpg
                
                if($image_arrays[0]){  $image_Available=true; }
                else{
                	$fnameFTP = $objCore->_SYS['CONF'][$ftploc].'/thumbs/'.$list_spec[0][0];
                }
              ...
              //  echo $fnameFTP;
                ...
                if($image_arrays[0]){
                	...
                	$image_arrays[0]=$list_spec[0][0];
                	$imgUrl = $objCore->_SYS['CONF'][$httploc]."/large/".$list_spec[0][0];
                }
		//echo '<img src="'.$imgUrl.'" />';
...
var y = document.getElementById("fbshairimg").src;
alert(addressBarURL);

document.write('<meta property="og:image" content="'+y+'"  >');
...
<!-- fb and twitt start--><?php 
$currentUrl="http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";echo ' ';$_SERVER['HTTP_REFERER']
...
<!-- end ashan -->
    ...
    <div id="gallery" class="ad-gallery" >
        ...
        foreach($image_arrays as $images){
            ...
            //if($image_Available){
            ?>
		        <a id="zoom-<?php echo $j; ?>" style="<?php echo $style; ?>" href="javascript: zoom('<?php echo $objCore->_SYS['CONF']['URL_IMG_UPLOAD_MODULE'];?>/zoom_prods.php','<?php echo $images.'_spl_'.$_REQUEST['cid']; ?>','<?php echo $com; ?>');">
		        	<img  border="0" src="<?php echo $objCore->_SYS['CONF']['URL_ICONS_FRONT'];?>/zoom.png"/>
		        </a>
      <?php // }
        $j++;
        }
          ...
          <ul class="ad-thumb-list">
            ...
            foreach($image_arrays as $images){
              ...
              <a href="<?php echo $image_slider[$n]; ?>">
               <img src="<?php echo $image_slider[$n]; ?>" class="image<?php echo $n;?>" id="image<?php echo $n; ?>" onclick="changediv('<?php echo $n; ?>');">
