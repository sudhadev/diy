    ...
    <div class="spec_table_line">
        <div class="<?php echo $arrRowStyle[0];?>">
            ...
            <div class="spec-menu">
                ...
                <ul>
                    <?php  for($b=0;$b<count($specArray[$specKeyArray[$itemCounter]]);$b++) {
        ...
        <div class="<?php echo $arrRowStyle[1];?>">
            <div class="spec_table_topics">
                <div  class="sub_title"><?php echo $specKeyArray[$itemCounter];?> <?php /*<a href="?f=manufac&tcid=<?php echo $_REQUEST['tcid'];?>&pcid=<?php echo $_REQUEST['pcid'];?>&catId=<?php echo $_REQUEST['catId'];?>&specId=<?php echo $specDataArray[$specKeyArray[$itemCounter]][0][0];?>"><?php echo $specKeyArray[$itemCounter];?></a>*/?>
                </div>
            </div>
            <div class="spec-menu">
