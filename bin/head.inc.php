...
<div class="topbar_nav"><a href="<?php echo $objCore->_SYS['CONF']['URL_SYSTEM'];?>/blog/" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image10','','<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/green-idea-rollover.jpg',1)"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/green-idea-<?php if($objCore->curSection()=="blog") echo "rollover";?>.jpg" name="Image10" border="0" id="Image10" /></a></div>
...
<!-- <div class="topbar_nav"><a href=" --><?php //echo $objCore->_SYS['CONF']['URL_SYSTEM'];?><!-- /blog/" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image12','',' --><?php //echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?><!-- /contact-us-rollover.jpg',1)"><img src=" --><?php //echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?><!-- /contact-us --><?php //if($objCore->curPage()=="contact_us.php") echo "-rollover";?><!-- .jpg" name="Image12" border="0" id="Image12" /></a></div> -->
