  ...
  <div id="main_form_bg">
    <div id="main_form_bg_middle">
      ...
      <div id="main_form_bg_middlebar">
        <div id="loging_banner">SUPPLIER LOG IN</div>
        ...
        <div id="outer">
          <div id="outer_middle">
            ...
            <div id="signup_butten"><a href="<?php echo $objCore->_SYS['CONF']['URL_FRONT'];?>/signup/"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/sign-up-button.png" border="" /></a></div>
          </div>
        </div>
      </div>
