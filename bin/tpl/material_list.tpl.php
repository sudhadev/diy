                        ...
                        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="9" align="left" valign="top">
                                    ...
                                    //echo str_replace('order_by=0','order_by=5',$query_string);
                                    ?>
                                    ...
                                    <div class="unit_Price<?php echo ($_REQUEST['order_by'] == '5' || $_REQUEST['order_by'] == 0)? "_sorted":"";// Changed by Saliya?>">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="5" height="20"></td>
                                                <td height="20" align="right"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <td width="370" height="50" align="center" valign="middle">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            ?>
                                            <img 
                                              	onclick="location.href='<?php echo $objCore->_SYS['CONF']['URL_FRONT'];?>browse/?f=more&catid=1&cid=<?php echo $list[$i][11]; ?>&lid=<?php echo $list[$i][18]; ?>';" 
                                              	src="<?php echo $imgUrl;?>" width="90" border="0" 
                                              	style="cursor: hand; padding-right:8px; padding-left: 5px;padding-top: 5px;"/>
...
//echo '<a href="'.$objCore->_SYS['CONF']['URL_FRONT'].'browse/?f=more&catid=1&cid='.$list[$i][11].'&lid='.$list[$i][18].'&dis='.$distance.'">Photos ('.$count.') </a>';
        ...
        ?>
                                                ...
                                                <div class="supplies_text_common" style="margin-left: 100px; padding-top: 5px;text-align: left;margin-bottom: 10px;<?php if ($_REQUEST['latitude'] && $_REQUEST['longitude']) {?> width: 220px; <?php }else{?> width: 230px;<?php }?> "> 
                                                    <strong>
                                                    	<?php echo '<a href="'.$objCore->_SYS['CONF']['URL_FRONT'].'browse/?f=more&catid=1&cid='.$list[$i][11].'&lid='.$list[$i][18].'&dis='.$distance.'">';?>
                                                    		<?php //echo strtoupper($list[$i][15]).'&nbsp;'; ?>
                                                    		<?php echo $list[$i][10]?>
                                                    	<?php echo '</a>';?>
                                                    </strong>
                                                    <br/><br/>
                                    ...
                                    <?php ///echo $list[$i][11].",".$_REQUEST['latitude'].",".$_REQUEST['longitude']; ?>
                                    <?php if ($_REQUEST['latitude'] && $_REQUEST['longitude']) {?>
		                                <td width="55" height="50" align="center" valign="middle" class="list_style_spc3">
		                                	<div align="center">
		                                		<?php //echo round($list[$i][12], 2);
                                                    $distance_claculate = $objSearch->getDistance_ni_moreInfo( $list[$i][11], $_REQUEST['latitude'], $_REQUEST['longitude']);
                                                    echo $distance_claculate = round($distance_claculate, 2);
		                                		?> 
		                                	</div>
		                                </td>
                                        <?php }?>
                                <td width="43" height="50" align="center" valign="middle" class="list_style_spc3"><div align="center" class="list_style_spc3"><?php if($list[$i][9]!='Ring' && $list[$i][9]!='Free'){?>&pound;<?php }?><?php echo $list[$i][9]; ?></div></td>
                                ...
                                <td width="46" height="50" align="center" valign="middle"><label>
                                        <input type="checkbox" name="checkVal[<?php echo $i;?>]" id="checkVal[<?php echo $i;?>]" value="<?php echo $list[$i][18];?>"
                                               onclick="javascript:selectItems('<?php echo $list[$i][18];?>','<?php echo count($list); ?>');"/>
                                    </label></td> 
                            </tr>
                            <tr>
                                <td height="2">
