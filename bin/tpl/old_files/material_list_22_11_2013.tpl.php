...
echo '<a href="'.$objCore->_SYS['CONF']['URL_FRONT'].'browse/?f=more&catid=1&cid='.$list[$i][11].'&lid='.$list[$i][18].'&dis='.$distance.'">Photos ('.$count.') </a>';
        ...
        ?>
                                                ...
                                                <div class="supplies_text_common" style="margin-left: 100px;padding-top: 5px;text-align: left;margin-bottom: 10px;"> 
                                                    ...
                                                    <?php if($list[$i][28]!=""){?>
                                                    <span><a href="<?php echo "http://".str_replace("http://", '', $list[$i][28]);?>"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/visit-website.png"/></a></span>
                                                    <?php } ?>
                                ...
                                <td width="55" height="50" align="center" valign="middle" class="list_style_spc3"><div align="center"><?php echo round($list[$i][12], 2);?> </div></td>
                                        <?php }?>
                                <td width="43" height="50" align="center" valign="middle" class="list_style_spc3"><div align="center" class="list_style_spc3"><?php echo $list[$i][9]; ?></div></td>
                                <td width="46" height="50" align="center" valign="middle" class="list_style_spc3"><div align="center"><?php echo $list[$i][7]."+"; ?></div></td>
                                <td width="48" height="50" align="center" valign="middle" class="list_style_spc1"><div align="center"><?php echo $list[$i][6]; ?></div></td>
                                <td width="48" height="50" align="center" valign="middle" class="list_style_spc3"><div align="center"><?php echo $list[$i][8]; ?></div></td>
