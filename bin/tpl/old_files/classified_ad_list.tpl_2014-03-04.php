...
<!--			<div class="select_wishlist">
			...
			<div class="distance_main">
				...
				<div class="hourly_rate_amount distance_font" style="width: auto;max-width: 220px;">
                                <?php 
                                    if($objCore->sessCusId=="" || $Classifiedlist[$i][7]=='--'){ 
                                        echo " - "; 
                                    }else{ 
                                        echo round($Classifiedlist[$i][7], 2).' '.$unit;
                                    }
                                ?>
                                </div>
                        ...
                        <img onclick="selectcheck('checkVal[<?php echo $i;?>]','<?php echo count($Classifiedlist); ?>');" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/add-to-wish-list.png" style="margin-left: 14px; margin-top: 10px;"/>
            <input type="checkbox" name="checkVal[<?php echo $i;?>]" id="checkVal[<?php echo $i;?>]" value="<?php echo $Classifiedlist[$i][14];?>" onclick="javascript:selectItems('<?php echo $Classifiedlist[$i][14];?>','<?php echo count($Classifiedlist); ?>');" style="    margin-top: -2px;
