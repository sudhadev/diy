					...
					<div class="description_text_big">
                                        ...
                                        <?php
                                            if(strlen($list[$i][20])>80){
                                                 echo nl2br(htmlentities($serviceList[$i][9], 0, 130)).'<span>...</span><a href="'.$objCore->_SYS['CONF']['URL_FRONT'].'browse/?f=more&catid=2&cid='.$serviceList[$i][6].'&lid='.$serviceList[$i][20].'&dis='.round($serviceList[$i][7], 2).'&unit=miles" style="text-decoration:underline;font-weight:bold;"> more</a>';
                                            }else{
