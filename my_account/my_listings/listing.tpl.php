                                ...
                                <tr>
                                    <td class="list_blackbg_summery">
                                       ...
                                       <!-- <div id="clear_selected_button"><a href="javascript:clear_items();"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/list_clear_button.jpg" width="130" height="17" border="0" /></a></div> -->
                                        ...
                                        <div  id="list_submit_button">
                                            <!--a href="javascript:add_edit();" -->
                                            <a onclick="add_edit_before()" ondblclick="return false;" style="cursor:pointer">
                                                <img alt="" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/my_list_submit.png" border="0" id="list_submit_button-BT" />
                                                <img alt="" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/my_list_submit_hover.png" border="0" id="list_submit_button-hover-BT" style="display: none;" />
                                            </a>
                                            
                                            <!--button onclick="add_edit_before()" ondblclick="return false;" class="submit_listing_BT" id="list_submit_button-BT" >Submit Listing(s)</button>
                                            <button onclick="add_edit_before()" ondblclick="return false;" class="submit_listing_BT" id="list_submit_button-hover-BT" style="display: none;">Submit Listing(s)</button-->
...
<?php
                                            /* if(count($subcategory_list) == "" && $parent_ids!="")   </td></tr>
                                              ...
                                              { */
$mycounter=count($subcategory_list);
...
?>
                                        ...
                                        <tr>
                                            <td class="list_yellowbg_heading">
                                                <div class="double_arrow"><a href="javascript:display_listings('<?php echo $parent_ids . "_" . $subcategory_list[$i][0]; ?>',<?php echo $i; ?>);" ><img alt="" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/double-arrows.jpg" width="14" height="14" border="0" <?php if (isset($_COOKIE['tableid'])&&($_COOKIE['tableid']<$mycounter)){if($i==$_COOKIE['tableid']): echo "onload=\"display_listings('".$parent_ids . "_" . $subcategory_list[$i][0]."',".$i.") \"";  endif;}else{if($i==0): echo "onload=\"display_listings('".$parent_ids . "_" . $subcategory_list[$i][0]."',".$i.") \""; endif;}?> onclick="setTimeout(function(){myfun();},1500);"></a></div>
                                        ...
                                        <tr id="listing_add_list_tr_<?php echo $i; ?>" class="listing_add_list_tr_class" style="display:none">
...
?>
                                       ...
                                       <!-- <div id="clear_selected_button"><a href="javascript:clear_items();"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/list_clear_button.jpg" width="130" height="17" border="0" /></a></div> -->
                                        ...
                                        <div  id="list_submit_button">
                                            <!--a href="javascript:add_edit();"-->
                                             <a onclick="add_edit_before()" ondblclick="return false;" style="cursor:pointer">
                                                <img alt="" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/my_list_submit.png" border="0" id="list_submit_button-BT-2" />
                                                <img alt="" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/my_list_submit_hover.png" border="0" id="list_submit_button-hover-BT-2" style="display: none;" />
                                            </a>
                                                <!--button onclick="add_edit_before()" ondblclick="return false;" class="submit_listing_BT" id="list_submit_button-BT-2" >Submit Listing(s)</button>
                                                <button onclick="add_edit_before()" ondblclick="return false;" class="submit_listing_BT" id="list_submit_button-hover-BT-2" style="display: none;">Submit Listing(s)</button-->
...
/* var x=0;
document.cookie = 'tableid='+x;  */ 
function myfun(){
x=document.getElementById("lastClicked").value;
document.cookie = 'tableid='+x;  
}
</script>
<?php  
    /* echo $_COOKIE['tableid']; */  
?> 