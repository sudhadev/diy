...
?>
            ...
            <td class="chagrs_grid_text">
                ...
                <div id="delivery_show_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>_div" class="numeric_txtfield" ><?php if($print_value){ echo $print_value;}else{ echo "&nbsp;";} ?></div>
                
                <input type="hidden" value="<?php echo $print_value; ?>" name="delivery_show_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" id="delivery_show_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" class="numeric_txtfield" size="4" onchange="checkValue('<?php echo $ids; ?>','<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>');"/></td>
            <td></td>
            <td class="chagrs_grid_text">
