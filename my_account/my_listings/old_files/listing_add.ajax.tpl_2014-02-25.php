...
?>
        ...
        ?>
                ...
                <tr><td>
                        ...
                        <input type="hidden" value="<?php if(($specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][18])>0) echo $specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][18]; else echo "Free"; ?>" name="list_rate_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" id="list_rate_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" />
...
?>
    ...
    /*        echo $delivery_rate_value;
            ...
            if($delivery_rate_value=='Free'  || $delivery_rate_value=='0.00' || $delivery_rate_value==''){ /* Add by maduranga*/            	$print_value = "Free";            }else if($delivery_rate_value=='Ring'){            	$print_value = "Ring";            }else{            	$print_value = $delivery_rate_value;            }
            ?>
