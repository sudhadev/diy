    ...
    ?>
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            if($objListing->check_Image_Available($image_hid_one, $objCore->_SYS['CONF']['FTP_LISTINGS'], $objCore->_SYS['CONF']['URL_IMAGES_LISTINGS'], $objCore->sessCusId)){
                                /*add by maduranga*/
                            }else{
                                $image_hid_one='no_image.jpg';
                            }
                        ?>
