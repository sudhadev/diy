            ...
            <tbody>
                ...
                ?>
                    ...
                    echo "&nbsp;";
                            ...
                            <td align="center">
                                <a href="http://diypricecheck.co.uk/my_account/my_listings/?f=del&delId=<?php echo $specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][11]; ?>" alt="Delete" title="Delete">
