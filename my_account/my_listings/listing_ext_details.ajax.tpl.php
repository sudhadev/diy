...
if ($_POST['id'] != '') {
    ...
    $listing_spec[0][3] = trim($listing_spec_id[0][3]);
    ...
    $listing_spec[0][3] = trim($listing[0][3]);
...
<!--                    <input type="file" class="add_cladds_txtfield" name="filename" onchange="clearMsg('error_msg');getFieldNames('keyName','extDat','zooming'); ajaxUpload(this.form,'<?php echo $objCore->_SYS['CONF']['URL_IMG_UPLOAD_MODULE']; ?>/ajaxupload.php','uploadingImg','divProcess');  this.value='';return true;" />nput type="file" class="add_cladds_txtfield" name="filename4" onchange="clearMsg('error_msg');getFieldNames('keyName4','extDat','zooming4'); ajaxUpload(this.form,'<?php echo $objCore->_SYS['CONF']['URL_IMG_UPLOAD_MODULE']; ?>/ajaxupload.php','uploadingImg4','divProcess');  this.value='';return true;" />-->
            ...
            <div class="contact_fieldBlock_right">
                ...
                <input type="text" id="listheader" name="listheader" value="<?php if($listing[0][21]){ echo $listing[0][21]; }else{ echo $listing_spec[0][3]; } ?>" style="width: 400px;"/>
...
?>
            ...
            <div class="contact_fieldBlock_right"> 
            <?php //echo '||'.$post_values[8].'>>'.$post_values[9]; ?>
            	<select  onchange="toggleselection2('select_delivery','select_rate')"; name="select_delivery" id="select_delivery" class="mng_mylistings_short" style="width:140px;">
            	<?php	$options	= ' ' . "\n";
            	if( $post_values[8]=="Free" || $post_values[8]=="free" || $post_values[8]=="0" || $post_values[8]==""){
            		$options	.='<option value="0" selected>Free UK</option>' . "\n";
					$options	.='<option value="1">Ring for Details</option>' . "\n";
					$options	.='<option value="2">Input Amount</option>' . "\n";
					
					$select_rate_value = "Free";
					
            	}else if($post_values[8]=="Ring" || $post_values[8]=="ring"){
            		$options	.='<option value="0" >Free UK</option>' . "\n";
					$options	.='<option value="1" selected>Ring for Details</option>' . "\n";
					$options	.='<option value="2">Input Amount</option>' . "\n";
					
					$select_rate_value = "Ring";
					
            	}else if($post_values[8]!="" && $post_values[8]!="Ring" && $post_values[8]!="Free" && $post_values[8]!="ring" && $post_values[8]!="free"){
            		$options	.='<option value="0">Free UK</option>' . "\n";
					$options	.='<option value="1">Ring for Details</option>' . "\n";
					$options	.='<option value="2" selected>Input Amount</option>' . "\n";
					
					$select_rate_value = $post_values[8];
          ...
          <?php */?>
                ...
                <span style="margin-left: 15px;"><strong>If Yes:</strong>  
                    ...
                    ?>
                        ...
                        <?php echo ' £ ';?>
                        	<?php if($select_rate_value=="Free" || $select_rate_value=="Ring"){?>
                        	<input value="<?php echo $select_rate_value; ?>" type="text" name="select_rate" id="select_rate" class="mng_mylistings_short" style="width:140px;"  disabled/>
                        	<?php }else{ ?>
                        	<input value="<?php echo $select_rate_value; ?>" type="text" name="select_rate" id="select_rate" class="mng_mylistings_short" style="width:140px;"  />
                        	<?php } ?>
