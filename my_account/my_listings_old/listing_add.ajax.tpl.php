...
?>
        ...
        ?>
                ...
                <tr><td>
                        ...
                        <input type="hidden" value="<?php if(($specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][18])>0) echo $specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][18]; else echo "ring"; ?>" name="list_rate_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" id="list_rate_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" />
...
if( $specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][12] == ""){
 ...
 ?>
                        <a href="javascript: addExtraDetails('<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>','<?php echo $specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][11]; ?>');"	><img src="<?php echo $imgUrl; ?>" id="thumb_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>"  width="30" border="1" alt="Click here to change the image"/></a>

      <a style="color: #000;font-size: 12px;font-weight: normal;" href="javascript: addExtraDetails('<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>','<?php echo $specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][11]; ?>');">  <?php echo $specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][1]; ?> </a>
...
?>
            ...
            <td class="chagrs_grid_text">
                <input type="hidden" value="<?php echo $delivery_rate_value; ?>" name="delivery_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" id="delivery_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" class="numeric_txtfield" size="4" onchange="checkValue('<?php echo $ids; ?>','<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>');"/>
  
                <input type="text" value="<?php echo $print_value; ?>" name="delivery_show_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" id="delivery_show_<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>" class="numeric_txtfield" size="4" onchange="checkValue('<?php echo $ids; ?>','<?php echo $specListKeys[$n] . "_" . $manufactListKeys[$lsIt]; ?>');"/></td>
            <td></td>
            <td class="chagrs_grid_text">
                    <?php $lstStatus = $specification_list[$specListKeys[$n]][$manufactListKeys[$lsIt]][7]; ?>
                <select id="listing_active_<?php echo $specListKeys[$n]."_".$manufactListKeys[$lsIt];?>" class="mng_mylistings_short" name="listing_active_<?php echo $specListKeys[$n]."_".$manufactListKeys[$lsIt];?>" onclick="changeColor('<?php echo $ids;?>','<?php echo $specListKeys[$n]."_".$manufactListKeys[$lsIt];?>');"
                        style="<?php if($lstStatus=="Y" ) {?> border-color:#009966; <?php }else { ?> border-color:#FF0000; <?php } ?>;">
                    <option value="Y"<?php if($lstStatus=="Y") {
                    echo " selected ";

                }?> >Yes </option>
                    <option value="N"<?php if($lstStatus=="N" || $lstStatus=="") {
                    echo " selected ";
                                }?> >No </option>
                </select>
