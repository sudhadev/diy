<?php
/*
  edit by maduranga 2014-01-23
 Replace "<?php $objCore->getCurrencyType(); ?>" to "£" and "&pound;" for Sri lankan Rs 
...
if(!is_object($objCore)){ $objCore=new Core(); }
...
$supplier_month_Error=FALSE;
$service_month_Error=FALSE;




for ($i=0; $i<count($subcriptionData); $i++) {
	$date_exp=$subcriptionData[$i][5];
	
	if ($subcriptionData[$i][2]=='S') {
		if ($subcriptionData[$i][3]){
			if(strtotime(date("Y-m-d"))>$date_exp){
				$service_month_Error=TRUE;
			}
		}
	}
}
...
//echo $supplier_month_Error.'|'.$service_month_Error;
?>
                    ...
                    <div align="left">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                             ...
                             <?php if($service_month_Error){?>
	                                <tr>
	                                	<td>
	                                		<div style=" color: #FF0000; float: left; margin-left:125px; margin-top: 5px;">
	                                			Your account has expired, go to "My Account" tab to renew 
	                                		</div>	                                		
	                                	</td>
	                                </tr>
								<?php } ?>
                                        ...
                                        <div id="personal" style="">
                                                ...
                                                <div class="option_form_catagories">
                                                    ...
                                                    <div class="text_fieldBlock_right">
                                                        <input <?php if($service_month_Error){?> readonly <?php }?> name="business_name" id="business_name" class="mng_myinfo_txtfield" value="<?php if ($serviceData) {echo $serviceData[0][9];}else {echo $_REQUEST['business_name'];} ?>" type="text">
                                                    </div>
                                                    
                                                    
                                                    <!--  Add by maduranga for service type   --->
                                                    <!-- div class="text_fieldBlock_left">Service Type:<span class="required_fields">*</span></div>
                                                    <div class="text_fieldBlock_right">
                                                        <?php /*for service type - add by maduranga*/
                                                           $service_type=$objCore->_SYS['CONF']['SERVICE_TYPE'];
                                                        ?>
                                                        <select id="service_type" name="service_type" class="mng_myinfo_txtfield">
                                                            <?php for($i=0;$i<count($service_type);$i++) { ?>
                                                            <option value="<?php echo $service_type[$i]; ?>" 
                                                            <?php  if ($serviceData) { if ($serviceData[0][19]==$service_type[$i]){?> selected="selected" <?php }} ?>>
                                                                    <?php echo $service_type[$i]; ?>
                                                                </option>
                                                           <?php  }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div style="float:left;">
                                                            ...
                                                            if($service_month_Error){
                                                            	echo '<select disabled="disabled" id="category" class="mng_myinfo_txtfield" name="category">
																			<option value=""> ---------------------- </option>
																		</select>';
                                                            }else{
	                                                            if ($serviceData) {
	                                                            ...
	                                                            echo $objCategory->getSubcList(2,'add_drop_list_cats','category','mng_myinfo_txtfield',$val,'');
                                                            }
	                                                        ?></div>
                                                    ...
                                                    <div class="text_fieldBlock_right">
                                                        <textarea  <?php if($service_month_Error){?> readonly <?php }?> name="description" class="mng_myinfo_txtfield"><?php if ($serviceData) {echo $serviceData[0][5];}else {echo $_REQUEST['description'];} ?></textarea>
                                                    </div>
                                                    <!--
                                                    ...
                                                    <div class="text_fieldBlock_right">
                                                        <textarea  <?php if($service_month_Error){?> readonly <?php }?> name="keywords" class="mng_myinfo_txtfield"><?php if ($serviceData) {echo $serviceData[0][4];}else {echo $_REQUEST['keywords'];} ?></textarea>
                                                    </div>
                                                    <div class="text_fieldBlock_left">Website:</div>
                                                    <div class="text_fieldBlock_right">
                                                        <input  <?php if($service_month_Error){?> readonly <?php }?> name="website" id="website" class="mng_myinfo_txtfield" value="<?php if ($serviceData) {echo $serviceData[0][18];}else {echo $_REQUEST['website'];} ?>" type="text">
                                                  
                                                    </div>
                                                    <div class="text_fieldBlock_left">Call out charge:</div>
                                                    <div class="text_fieldBlock_right">
                                                       
                                                    <select name="callOutCharge" id="callOutCharge" class="mng_mylistings_short" style="width:140px;"  <?php if($service_month_Error){?> disabled="disabled"<?php }?>>
                                                        <?php
                                                                $bdOptionListRate = '<option value="0" >No</option>' . "\n";
                                                                $i = 5;
                                                                while($i<55){
                                                                    $bdOptionListRate .= '<option value="'.$i.'" > &pound; '.$i.'</option>' . "\n";
                                                                    $i = $i+5;
                                                                    }
                                                   ...
                                                   <?php //print_r($serviceData); ?>
                                                    ...
                                                    <div class="text_fieldBlock_right">
                                                    <input  <?php if($service_month_Error){?> readonly <?php }?> name="hourlyRate" id="hourlyRate" class="mng_myinfo_txtfield" value="<?php echo $serviceData[0][6]; ?>" type="text">
...
<!--                                    </div>-->
	...
	z-index: 2;width: 80px;" class="add_cladds_txtfield" name="filename" onchange="clearMsg('error_msg');getFieldNames('keyName<?php echo $n; ?>','frmServices','zooming<?php echo $n; ?>'); ajaxUpload('Add_Classifieds_Image<?php echo $n; ?>','<?php echo $objCore->_SYS['CONF']['URL_IMG_UPLOAD_MODULE'];?>/ajaxupload.php','uploadingImg<?php echo $n; ?>','divProcess');  this.value='';return true;" />
      ...
      <?php if($service_month_Error){}else{?>   
...
?>
     	...
     	<label id="submit_contact_details">
		    <img alt="" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/submit.jpg" border="0" <?php if(!$service_month_Error){?>onClick="resetSubmit('frmServices','<?php echo $objCore->_SYS['CONF']['URL_SYSTEM'];?>/my_account/services/');"<?php } ?>>
		</label>
