 ...
 <tr class="<?php echo $arrRowStyle[($i)%2];?>">
    <td><div class="cadds_search_descriptionrow">
        ...
        <div class="description_text_big">
	        	...
	        	<strong>
	        		<?php echo '<a href="'.$objCore->_SYS['CONF']['URL_FRONT'].'browse/?f=more&catid=2&cid='.$listValues[$i][$j][6].'&lid='.$listValues[$i][$j][20].'&dis='.round($listValues[$i][$j][7], 2).'&unit=miles"  style="font-family: Arial,Helvetica,sans-serif;color: #333333;
    font-size: 16px;
    font-weight: bold;">'; ?>
	        			<?php echo $listValues[$i][$j][8];?>
	        		<?php echo '</a>';?>
	        	</strong>
