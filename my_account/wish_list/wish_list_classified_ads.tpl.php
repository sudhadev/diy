...
<tr class="<?php echo $arrRowStyle[($i)%2];?>">
    <td><div class="cadds_search_descriptionrow">
        ...
        <div class="description_text_big"><strong>
        	<a href="<?php echo $objCore->_SYS['CONF']['URL_FRONT'].'browse/?f=more&catid=3&cid='.$listValues[$i][$j][6].'&lid='.$listValues[$i][$j][14]; ?>" style="font-family: Arial,Helvetica,sans-serif;color: #333333;
				    font-size: 16px;
				    font-weight: bold;">
