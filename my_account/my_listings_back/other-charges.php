...
<table width="652" cellspacing="0" cellpadding="0" border="0">
  <tbody><tr >
   ...
   <?php
    ...
    <td width="6">
    </td><td class="chagrs_grid_text"><strong><?php echo $listSuppliers[$ls][0]." ".$listSuppliers[$ls][1] ;?></strong><br/><a href="mailto:<?php echo $listSuppliers[$ls][3];?>"><?php echo $listSuppliers[$ls][3];?></a></td>
    <td width="1">
