...
<div id="right_bar_middle">
    <div id="main_form_bg">
        <div id="main_form_bg_middle">
            <div id="main_form_bg_topbar"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'].$image_localization;?>/main_form_bg_top.jpg" /></div>
...
<!--                                    <div class="option_form_selections">
                                    ...
                                    <div id="elementsToOperateOn2" class="option_form_sub_selections">
                                        <div id="prBox" class="active" <?php if($errMsg2){?> style="background-color: #fcc;"<?php }?>>
                                                <span id="msg"> <?php echo $errMsg2;?></span>
                                                <span class="textMain">If You have a promotional code please enter it here.</span> <input id="prCode2" name="prCode2"  value="<?php if(isset($_REQUEST['promo_code2'])) echo $_REQUEST['promo_code2']; else echo $_REQUEST['prCode2'];?>" />
                            ...
                            <? /*
                                                ...
                                                <div class="option_form_selections">
                                                  ...
                                                  Supplies <img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'].$image_localization;?>/info.png" onmouseover="showPopup('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vehicula nunc in nunc.','#FFFFFF')" onmouseout="hidePopup()" />  </div>
                                                ...
                                                <div class="option_form_selections">
                                                  ...
                                                  Services <img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'].$image_localization;?>/info.png" onmouseover="showPopup('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vehicula nunc in nunc.','#FFFFFF')" onmouseout="hidePopup()" /> </div>
                                                <div id="packages_s"></div>
                                                <div class="option_form_selections">
                                                  <label>
                                                  <input type="radio" id="classified" value="C" checked="true" disabled />
                                                  </label>
                                                  Classified Ads <img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'].$image_localization;?>/info.png" onmouseover="showPopup('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vehicula nunc in nunc.','#FFFFFF')" onmouseout="hidePopup()" />  </div>
                                                  <div class="option_form_sub_selections" style="padding:5px;width:570px;">
                                                  <?php echo $pageContents['option_form_sub_selections'];?>
                                                  </div>
                    ...
                    <div id="signup_butten" align="left">
                        <?/*
                                    <a href="javascript:subscription.submit();"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'].$image_localization;?>/next-button.jpg" border="" onClick="subscription.submit();"/></a>
                                                */?>
                    </div>
                </div>
            </div>
        </div>
        <div id="main_form_bg_bottombar"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'].$image_localization;?>/main_form_bg_bottom.jpg" /></div>
    </div>
</div>
</div>
