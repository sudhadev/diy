...
<div class="option_form_sub_selections">
  ...
  <div class="option_form_sub_text_selections">
    ...
    Silver <img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/info.png" onmouseover="showPopup('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vehicula nunc in nunc.','#FFFFFF')"; onmouseout="hidePopup()" />
  </div>
  <div class="option_form_sub_text_selections">
    <label>
    <input name="packages" type="radio" id="gold" value="G" />
    </label>
    Gold <img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/info.png" onmouseover="showPopup('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vehicula nunc in nunc.','#FFFFFF')"; onmouseout="hidePopup()" />
  </div>
</div>
