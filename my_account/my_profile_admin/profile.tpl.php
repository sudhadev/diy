...
<?php
echo $objComponent->drop('title', $customerInfo[14], array(
    "" => "--",
    "Mr." => "Mr.",
    "Miss." => "Miss.",
    "Mrs." => "Mrs.",
...
?>
                                                                ...
                                                                <div class="text_fieldBlock_right">
                                                                    <label>
                                                                        <input name="email" type="text" id="email" class="myprof_editdetails_txtfield" value="<?php echo $customerInfo[11]; ?>" readonly/>
                                                                    </label>
                                                                </div>
                                                                <div class="text_fieldBlock_left">Confirm E-mail:</div>
                                                                <div class="text_fieldBlock_right">
                                                                    <label>
                                                                        <input name="emailConfirm" type="text" id="emailConfirm" class="myprof_editdetails_txtfield" value="<?php echo $customerInfo[11]; ?>" readonly/>
                                                                    </label>
                                                                </div>
                                                            </div>
  <!--                                                          <label id="submit_contact_details" ><img style="margin: 40px 0px 0px 20px;" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/submit.jpg" border="" 
                                                        ...
                                                        <div class="add_classified_formmiddle" style="display: none;" id="divProfileAddress">
                                                            ...
                                                            <div class="text_fieldBlock_right">
                                                                <label>
                                                                    <?php
                                                                    $objCountry->style = 'myprof_editdetails_txtfield'; // css style for country drop down
                                                            ...
                                                            <input type="hidden" id="customerId" name="customerId" value="<?php echo $objCore->sessCusId; ?>">
<!--                                                                   <label id="submit_contact_details">
                                                                                  <img style="margin: 40px 0px 0px 20px;" 
                                                                                       ...
                                                                                       //updatePersonal('<?php echo $objCore->sessCusId; ?>', document.personal_details.title.value, document.personal_details.fName.value, document.personal_details.lName.value, document.personal_details.email.value, document.personal_details.emailConfirm.value)"/>
                                          ...
                                          <!--                  <label id="submit_contact_details"><img style="margin: 40px 0px 0px 20px;"
                                                                                                    src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT']; ?>/submit.jpg" border="" 
                                                                                                    onClick="updateContact('<?php echo $objCore->sessCusId; ?>', document.contact_details.phone.value, document.contact_details.fax.value, document.contact_details.mobile.value)"/></label>
