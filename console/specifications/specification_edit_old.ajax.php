...
<div class="clr"></div>
	    ...
	    <tr>
	      <td class="key" align="right">Specification<span class="required_fields">*</span></td>
	      <td><?php if($listingAvailable){ echo $list[0][4];?><input name="specification" class="text_area" id="specification" size="30" type="hidden" value="<?php echo str_replace('-amp;','&',$list[0][4]); ?>"/> <?php }else{?><input name="specification" class="text_area" id="specification" size="30" type="text" value="<?php echo str_replace('-amp;','&',$list[0][4]); ?>"/><?php }?></td>
        </tr>
		 ...
		 <td>
                    ...
                    <div id="uploadingImg">
                        ...
                        <?php
                            if($cData['image'] != "") {
                        ?>
                        <a href="javascript: zoom('<?php echo $objCore->_SYS['CONF']['URL_IMG_UPLOAD_MODULE'];?>/zoom_prods.php','<?php echo $cData['image']; ?>','specs');"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_CONSOLE'];?>/icons/zoom.png" /></a>
                             <!-- Dlete Image -->
                            <?php 
                              $pos = strrpos($imageQuote, "no_image.jpg");
                              if ($pos === false) { // note: three equal signs
                             ?>  
                             <a href="javascript:delImage('<?php echo $objCore->_SYS['CONF']['URL_IMG_UPLOAD_MODULE'];?>/delete.ajax.php','specs','<?php echo $cData['image'];?>','<?php echo $objCore->sessUId;?>','0');" title="Delete Image" style="text-decoration:none"><img alt="delete" src="<?php echo $objCore->_SYS['CONF']['URL_ICONS_FRONT'];?>/delete_img_str.png" border="0"  /> </a>
                              <?php  }// end of $pos
                            ?>
                            <!-- / Delete Image -->
                        <?php
