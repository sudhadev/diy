  ...
  <fieldset  id="page-middle-middle-content">
      ...
      <table  cellspacing="1" class="adminlist" width="100%">
        <thead>
          <tr>
            ...
            <th width="14%" nowrap="nowrap" class="title" align="left"><a  href="#">Added Time</a></th>
	...
	?>
          <tr class="row0">
            ...
            $imgUrl = $objCategory->image($list[$n][12],$objCore->_SYS['CONF']['FTP_SPECS'],$objCore->_SYS['CONF']['URL_IMAGES_SPECS']);

            ?>
            <img src="<?php echo $imgUrl;?>" width="50"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $list[$n][4];?><br />
            <?php 
	  	if($list[$n][12] != "")
	  	{
	?>
		  <a href="javascript: zoom('<?php echo $objCore->_SYS['CONF']['URL_IMG_UPLOAD_MODULE'];?>/zoom_prods.php','<?php echo $list[$n][12]; ?>','specs');"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_CONSOLE'];?>/icons/zoom.png" /></a>
	<?php 
	  	} else
	 	 {
	 ?> 
	 	 <a href="javascript: zoom('<?php echo $objCore->_SYS['CONF']['URL_IMG_UPLOAD_MODULE'];?>/zoom_prods.php','no_image.jpg','specs');"><img src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_CONSOLE'];?>/icons/zoom.png" /></a>
	<?php 
		}
	?>
                 
            <?php //echo $list[$n][4];?></td>
            <td align="left"><?php echo str_replace('-amp;','&',$list[$n][9]);?></td>
            <td align="left"><?php if($list[$n][7]) echo date($objCore->gConf['DATE_FORMAT']." ".$objCore->gConf['TIME_FORMAT'],$list[$n][7]); else echo "<i>Not found</i>"?></td>
