...
function editSpecData(ids,state)
{
	document.getElementById("divMessage").innerHTML= "";
        ...
        request.send("spec="+specification + "&desc=" + description + "&kWords=" + keywords + "&avgpri=" + average_price + "&ids=" + ids + "&state=" + status + "&manufacturer=" + manufacturer + "&oldmanu=" + oldManu+ "&pg=" + pg +"&val=edit");
}
...
function addSpecData()
{
	...
	reqSpec.send("spec="+specification + "&avgpri="+average_price + "&desc=" + description + "&ids="+cPath + "&manufacturer=" + manufacturer + "&kword=" + keywords +"&val=add");
