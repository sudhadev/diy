...
switch ($action) {
    ...
    case "addprom": {
            ...
            if ($_POST['select_cus_Type'] == 1) {
                $msg = $objPromotion->onRegistration($_POST['package'], $_POST['email'], $_POST['grace_period'], $_POST['ex_period'], $_POST['select_cus_Type']);
            } else if ($_POST['select_cus_Type'] == 2) {
                $msg = $objPromotion->onRegistration($_POST['packages2'], $_POST['email'], $_POST['grace_period'], $_POST['ex_period'], $_POST['select_cus_Type']);
            }
    ...
    case 'changepw': {
            $objCustomer->updatePasswordsBulk();
        }
}
