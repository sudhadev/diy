...
<div id="right_bar_middle">
  <div id="main_form_bg">
    <div id="main_form_bg_middle">
      ...
      <div id="main_form_bg_middlebar">
                  <!---------------------------------------------------------------------------------------------------->
                  <div id="banner_add_cads">CHANGE ACCOUNT DETAILS</div>
...
<!--                        Below are the account details held at present. If your would like to change any information, click on either of the tabs, Personal Details, Address or Contact Details, change the relevant information and press the "submit" button.  </div>-->
                                ...
                                <div class="configure_quot_frame_top"> </div>
								     ...
								     <div class="add_classified_formmiddle" style="display: block;" id="divProfilePersonal">
                                          <!--  personal data -->
                                                        ...
                                                        <form id="personal_details" name="personal_details" method="POST" action="">
                                                          <div class="" style="margin-top:15px;">
                                                            <div class="text_fieldBlock_left">Title:</div>
                                                            <div class="text_fieldBlock_right">
                                                            <?php 	 echo $objComponent->drop('title', $customerInfo[14], array(
                                                                        ""=>"--",
                                                                        "Mr."=>"Mr.",
                                                                        "Miss."=>"Miss.",
                                                                        "Mrs."=>"Mrs.",
                                                            ...
                                                            <div class="text_fieldBlock_right">
                                                              <label>
                                                                  <input name="fName" type="text" id="fName" class="myprof_editdetails_txtfield" value="<?php echo ucwords($customerInfo[0]); ?>"/>
                                                              </label>
                                                                  </div>
                                                            <div class="text_fieldBlock_left">Last Name:</div>
                                                            <div class="text_fieldBlock_right">
                                                              <label>
                                                              <input name="lName" type="text" id="lName" class="myprof_editdetails_txtfield" value="<?php echo ucwords($customerInfo[1]); ?>"/>
                                                              </label>
                                                                  </div>
                                                            <div class="text_fieldBlock_left">E-mail:</div>
                                                            <div class="text_fieldBlock_right">
                                                              <label>
                                                                  <input name="email" type="text" id="email" class="myprof_editdetails_txtfield" value="<?php echo $customerInfo[11]; ?>" disabled/>
                                                              </label>
                                                                  </div>
                                                            <div class="text_fieldBlock_left">Confirm E-mail:</div>
                                                            <div class="text_fieldBlock_right">
                                                              <label>
                                                              <input name="emailConfirm" type="text" id="emailConfirm" class="myprof_editdetails_txtfield" value="<?php echo $customerInfo[11]; ?>" disabled/>
                                                              </label>
                                                                  </div>
                                                          </div>
                                                          <label id="submit_contact_details" ><img style="margin: 40px 0px 0px 20px;" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/submit.jpg" border="" onClick="updatePersonal('<?php echo $objCore->sessCusId; ?>', document.personal_details.title.value, document.personal_details.fName.value, document.personal_details.lName.value, document.personal_details.email.value, document.personal_details.emailConfirm.value)"/></label>
                                                        </form>
                ...
                <form id="address_details" name="address_details" method="POST" action="">
                  <div class="option_form_catagories" style="border:none"> </div>
                    ...
                    <div class="text_fieldBlock_right">
                      <label>
                      <input name="company" type="text" maxlength="27" id="company"  class="myprof_editdetails_txtfield myprof_editdetails_txtfield_company" value="<?php echo $customerInfo[2]; ?>"/>
                    ...
                    <div class="text_fieldBlock_right">
                      <label>
                      <input name="address" type="text" id="address" class="myprof_editdetails_txtfield" style="text-transform: capitalize;" value="<?php echo ucwords($customerInfo[3]); ?>"/>
                      </label>
                  ...
                  <div class="text_fieldBlock_right">
                    <label>
                    <input name="street" type="text" id="street" class="myprof_editdetails_txtfield" style="text-transform: capitalize;" value="<?php echo ucwords($customerInfo[4]); ?>"/>
                    </label>
                    <br />
						  </div>
                  ...
                  <div class="text_fieldBlock_right">
                    <label>
                    <input name="city" type="text"  id="city" class="myprof_editdetails_txtfield" style="text-transform: capitalize;" value="<?php echo ucwords($customerInfo[5]); ?>"/>
                    </label>
                    <br />
						  </div>
                  ...
                  <div class="text_fieldBlock_right">
                    <label>
                        <input type="text" name="postcode" id="postcode" class="myprof_editdetails_txtfield" style="text-transform:  uppercase;" value="<?php echo strtoupper($customerInfo[6]); ?>"/>
                    </label>
                  </div>
                  ...
                  <input type="hidden" id="customerId" name="confirmedLongitude" value="<?php echo $objCore->sessCusId; ?>">
                  <label id="submit_contact_details"><img style="margin: 40px 0px 0px 20px;" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/submit.jpg" border="" onClick="initialize(); showAddress(document.<?=$formName; ?>.street.value+' '+document.<?=$formName; ?>.city.value+' '+document.<?=$formName; ?>.country.value); showMap();"/></label>
                ...
                <form id="contact_details" name="contact_details" method="POST" action="">
                  ...
                  <div class="text_fieldBlock_right">
                    <label>
                    <input type="text" name="phone" id="phone" class="myprof_editdetails_txtfield" value="<?php echo $customerInfo[8]; ?>"/>
                    </label>
						</div>
                  <div class="text_fieldBlock_left">Fax:</div>
                  <div class="text_fieldBlock_right">
                    <label>
                    <input type="text" name="fax" id="fax" class="myprof_editdetails_txtfield" value="<?php echo $customerInfo[9]; ?>"/>
                    </label>
                  </div>
                  <div class="text_fieldBlock_left">Mobile:</div>
                  <div class="text_fieldBlock_right">
                    <label>
                    <input type="text" name="mobile" id="mobile" class="myprof_editdetails_txtfield" value="<?php echo $customerInfo[10]; ?>"/>
                    </label>
                  </div>
                ...
                <form id="business_details" name="business_details" method="POST" action="">
                  ...
                  <div class="text_fieldBlock_right">
                    <label>
                    <input type="text" name="website" id="website" value="<?php echo $customerInfo[21];?>" class="myprof_editdetails_mrtxtfield" style="width:150px;"/>
                        
                    </label>
                  </div>
                   <div class="text_fieldBlock_left">Which listings would you like you website link to appear on :</div>
                  <div class="text_fieldBlock_right">
                      <table><tr><td>
   ...
   ">
    ...
    ">Classified Ads&nbsp;</span></td><td style="text-align: right;">
                   ...
                   <input type="hidden" name="list_st" id="list_st" value="<?php echo substr($customerInfo[22], 0, 1); ?>"/>
                      <input type="hidden" name="class_st" id="class_st" value="<?php echo substr($customerInfo[22], 2); ?>"/>
                  ...
                  <label id="submit_contact_details"><img style="margin: 40px 0px 0px 20px;" src="<?php echo $objCore->_SYS['CONF']['URL_IMAGES_FRONT'];?>/submit.jpg" border="" onClick="updateBusiness('<?php echo $objCore->sessCusId; ?>', document.business_details.mon_open.value+'_'+document.business_details.mon_close.value, document.business_details.sat_open.value+'_'+document.business_details.sat_close.value, document.business_details.sun_open.value+'_'+document.business_details.sun_close.value,document.business_details.website.value,document.business_details.list_st.value+'_'+document.business_details.class_st.value)"/></label>
