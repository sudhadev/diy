...
if (isset($_POST['submit'])) {
    ...
    if ($msg[0] == 'SUC') {
    	/*send an email to the custemer if the custemer data add succsessfully A++*/
    	$objEmail = new Email();
    	$objEmail->send('add_new_customer', $email,$title,'H',$fname,$lname);
    	//$objEmail->send('add_new_customer', $email);
    	/*A++*/
