	...
	*/
	...
	switch($action)
	{
		case "add":
		{
			...
			*/
			$msg=$objUser->add($_POST['fname'],$_POST['lname'],$_POST['uname'],$_POST['email'],$_POST['pword'],$_POST['vpword'],$_POST['uRole']);
		...
		case "edit":
		{
			...
			*/
			$msg=$objUser->edit($_POST['fname'],$_POST['lname'],$_POST['uname'],$_POST['email'],$_REQUEST['id'],$_POST['uRole']);
		...
		case "delete":
		{
			...
			* Call to the edit function in the User class.
			*/
			$msg=$objUser->delete($_REQUEST['id'],$objCore->sessUId);
		...
		case "change":
		{
			...
			* Call to the edit function in the User class.
			*/
			$msg=$objUser->changePword($_POST['npword'],$_POST['rpword'],$_POST['cpword'],$objCore->sessUId);
