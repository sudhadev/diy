...
`added_date`,`image2`,`image3`,`image4`) VALUES ('".$customerId."', '".$catId[0]."', '".$catId[1]."', '".$catId[2]."', '', '".$keywords."', '".$description."',
...
keywords, notes, price, call_out_charge, image, business_name, affiliations, contact_person, accreditation, website,image2,image3,image4 FROM
