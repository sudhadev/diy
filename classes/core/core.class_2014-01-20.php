...
Class Core{
    ...
    function  __Construct()
    {
        ...
        */
        $devPath='diydemo';	// folder path of development server - from the root
    ...
    public function msgBox($msgKey,$msg,$width="100%",$use=1,$msgText='',$msgImage='')
    {
        ...
        switch($use)
        {
            case 0:
                ...
                if(!$msgImage) $msgImage=$this->_SYS['MSGS'][$msgKey][$msg[1]][0];
                if(!$msgText) $msgText=$this->_SYS['MSGS'][$msgKey][$msg[1]][1];
    ...
    */
     ...
     */
                    ...
                    {//echo $this->guestId."<-------------";$this->objSql->dev=true;
