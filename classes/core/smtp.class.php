...
class Smtp {
    private $smtpServer = 'smtp.gmail.com';//'mail.authsmtp.com';
    private $port = '465';//'23';
    private $timeout = '180';
    private $username = 'sudharshan.ars@gmail.com';//'ac55480';
     
//private $password = 'bkadggn8wqkcpg';
    //private $password = 'bishoploveday';

    private $password = 'Xer011su';//'authsmtpdiy10';    
    private $newline = "\r\n";
    private $localdomain = 'diypricecheck.com';
