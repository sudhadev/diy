...
class Geo {
    ...
    function getCoordinates($formName, $submissionType = '', $ajaxFunction = '', $apiKey, $mapsUrl) {
        ...
        <?php
        return "<table><tr><td><div id=\"geoMap\" style=\"width: 500px;  display: none;\"><div id=\"map_canvas\" style=\"width: 500px; height: 300px;\"></div><br/><div id=\"msg\"></div><br/><div id=\"manual\"><input type=\"text\" id=\"latitude\" name=\"latitude\"/><input type=\"text\" id=\"longitude\" name=\"longitude\"/><br/> <input type=\"button\" name=\"relocate\" value=\"Relocate\" onClick=\"doRelocate();\"/><input type=\"button\" name=\"confirm\" id =\"confirm\" class=\"mybluebutton\" value=\"Confirm\" onClick=\"doSubmit();\"/><input type=\"button\" name=\"exit\" id =\"exit\" value=\"Exit\" onClick=\"doExit();\"/></div></div></td></tr></table>";
    }
