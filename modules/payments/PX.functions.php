...
// ** Set variables to indentify the vendor **
  ...
  $VendorName=$base->_SW['PAYMENT'][$base->_SW['GATE_WAY']]['USER'];
  $EncryptionPassword=$base->_SW['PAYMENT'][$base->_SW['GATE_WAY']]['PASS'];
...
//** Examples : $MyServer="https://www.newco.com/php-form-kit/", $MyServer="192.168.0.1/php-form-kit", $MyServer="http://localhost/php-form-kit/" **
  ...
  $MyServer=$base->_SW['URL_SHOP'];//"http://www.tidymyhome.co.uk/";

//*********************************************************************************
// The protx site to send information to **
  
  if($base->_SW['GATE_WAY_TEST_MODE']){
	$vspsite=$base->_SW['PAYMENT'][$base->_SW['GATE_WAY']]['URL_TEST'];
  }else{
	$vspsite=$base->_SW['PAYMENT'][$base->_SW['GATE_WAY']]['URL'];
